package com.dragn.bettasaquatics.biome;
...
public class BettaBiome {
    public static ResourceKey<Biome> KEY = ResourceKey.create(Registry.BIOME_REGISTRY, new ResourceLocation(BettasAquaticsMain.MODID, "betta_swamp"));
    ...
    public static class BettaRegion extends Region {
        ...
        public BettaRegion() {
            super(new ResourceLocation(BettasAquaticsMain.MODID, "betta_region"), RegionType.OVERWORLD, 2);
        }
    ...
    private static Biome makeBettaBiome() {
        ...
        mobSpawnSettings$builder.addSpawn(MobCategory.WATER_AMBIENT, new MobSpawnSettings.SpawnerData(BettasAquaticsMain.BETTA_ENTITY.get(), 20, 1, 30));
        mobSpawnSettings$builder.addSpawn(MobCategory.WATER_AMBIENT, new MobSpawnSettings.SpawnerData(BettasAquaticsMain.SNAIL_ENTITY.get(), 10, 1, 20));
        mobSpawnSettings$builder.addSpawn(MobCategory.WATER_AMBIENT, new MobSpawnSettings.SpawnerData(BettasAquaticsMain.KOI_ENTITY.get(), 10, 1, 20));
