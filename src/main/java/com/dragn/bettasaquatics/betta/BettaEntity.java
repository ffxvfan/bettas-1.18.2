...
public class BettaEntity extends AbstractFish implements IAnimatable {
    ...
    private static final EntityDataAccessor<int[]> COLOR_MAP =  SynchedEntityData.defineId(BettaEntity.class, (EntityDataSerializer<int[]>) BettasAquaticsMain.COLOR_SERIALIZER.get().getSerializer());
    ...
    public ItemStack getBucketItemStack() {
        return BettasAquaticsMain.BETTA_BUCKET.get().getDefaultInstance();
    }
    ...
    public SpawnGroupData finalizeSpawn(ServerLevelAccessor levelAccessor, DifficultyInstance difficultyInstance, MobSpawnType mobSpawnType, @Nullable SpawnGroupData spawnGroupData, @Nullable CompoundTag compoundTag) {
        if(compoundTag != null && compoundTag.contains("Model") && compoundTag.contains("BasePattern") && compoundTag.contains("ColorMap")) {
            ...
            setModel(BettasAquaticsMain.RANDOM.nextInt(Model.values().length));
            setBasePattern(BettasAquaticsMain.RANDOM.nextInt(BasePattern.values().length));
