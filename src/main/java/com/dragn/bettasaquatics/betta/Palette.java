...
public enum Palette {
    ...
    public static Palette getRandomPalette() {
        return Palette.values()[BettasAquaticsMain.RANDOM.nextInt(Palette.values().length)];
    }

    public int getRandomColor() {
        return colors[BettasAquaticsMain.RANDOM.nextInt(colors.length)];
    }

    public int getRandomShade() {
        return colors[BettasAquaticsMain.RANDOM.nextInt(shades.length)];
    }
}