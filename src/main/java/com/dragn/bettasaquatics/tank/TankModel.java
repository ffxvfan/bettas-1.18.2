...
public class TankModel implements IDynamicBakedModel {
    ...
    public static final Material BASE = new Material(TextureAtlas.LOCATION_BLOCKS, new ResourceLocation(BettasAquaticsMain.MODID, "blocks/base"));
    public static final Material WALLS = new Material(TextureAtlas.LOCATION_BLOCKS, new ResourceLocation(BettasAquaticsMain.MODID, "blocks/walls"));

    public static final Material[] ALGAE_LEVELS = {
            new Material(TextureAtlas.LOCATION_BLOCKS, new ResourceLocation(BettasAquaticsMain.MODID, "blocks/algae0")),
            new Material(TextureAtlas.LOCATION_BLOCKS, new ResourceLocation(BettasAquaticsMain.MODID, "blocks/algae1")),
            new Material(TextureAtlas.LOCATION_BLOCKS, new ResourceLocation(BettasAquaticsMain.MODID, "blocks/algae2")),
            new Material(TextureAtlas.LOCATION_BLOCKS, new ResourceLocation(BettasAquaticsMain.MODID, "blocks/algae3")),
            new Material(TextureAtlas.LOCATION_BLOCKS, new ResourceLocation(BettasAquaticsMain.MODID, "blocks/algae4"))
    };
