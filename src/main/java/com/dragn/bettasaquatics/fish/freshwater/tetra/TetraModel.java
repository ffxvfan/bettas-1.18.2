...
public class TetraModel extends AnimatedGeoModel<TetraEntity> {
    ...
    public static final ResourceLocation MODEL_RESOURCE_LOCATION = new ResourceLocation(BettasAquaticsMain.MODID, "geo/tetra.geo.json");
    public static final ResourceLocation animationResource = new ResourceLocation(BettasAquaticsMain.MODID, "animations/tetra.animation.json");
