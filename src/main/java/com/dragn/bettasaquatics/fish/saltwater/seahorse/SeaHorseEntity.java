...
public class SeaHorseEntity extends AbstractSchoolingFish implements IAnimatable {
    ...
    public static boolean checkBettasAquaticsTropicalFishSpawnRules(EntityType<SeaHorseEntity> p_186232_, LevelAccessor levelAccessor, MobSpawnType p_186234_, BlockPos pos, Random p_186236_) {
    ...
    public ItemStack getBucketItemStack() {
        return BettasAquaticsMain.SEAHORSE_BUCKET.get().getDefaultInstance();
    }
