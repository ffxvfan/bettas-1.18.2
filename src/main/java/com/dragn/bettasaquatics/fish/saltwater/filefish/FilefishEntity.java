...
public class FilefishEntity extends AbstractFish implements IAnimatable {
    ...
    public static boolean checkBettasAquaticsTropicalFishSpawnRules(EntityType<FilefishEntity> p_186232_, LevelAccessor levelAccessor, MobSpawnType p_186234_, BlockPos pos, Random p_186236_) {
    ...
    public ItemStack getBucketItemStack() {
        return BettasAquaticsMain.FILEFISH_BUCKET.get().getDefaultInstance();
    }
