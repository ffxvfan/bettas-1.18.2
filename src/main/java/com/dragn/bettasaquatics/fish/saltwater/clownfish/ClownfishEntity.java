...
public class ClownfishEntity extends AbstractSchoolingFish implements IAnimatable {
    ...
    public static boolean checkBettasAquaticsTropicalFishSpawnRules(EntityType<ClownfishEntity> p_186232_, LevelAccessor levelAccessor, MobSpawnType p_186234_, BlockPos pos, Random p_186236_) {
    ...
    public ItemStack getBucketItemStack() {
        return BettasAquaticsMain.CLOWNFISH_BUCKET.get().getDefaultInstance();
    }
