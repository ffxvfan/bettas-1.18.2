...
public class SeaStarEntity extends AbstractFish implements IAnimatable {
    ...
    public static boolean checkBettasAquaticsTinyTropicalFishSpawnRules(EntityType<SeaStarEntity> p_186232_, LevelAccessor levelAccessor, MobSpawnType p_186234_, BlockPos pos, Random p_186236_) {
    ...
    public ItemStack getBucketItemStack() {
        return BettasAquaticsMain.SEASTAR_ITEM.get().getDefaultInstance();
    }
    ...
    public SpawnGroupData finalizeSpawn(ServerLevelAccessor levelAccessor, DifficultyInstance difficultyInstance, MobSpawnType mobSpawnType, @Nullable SpawnGroupData spawnGroupData, @Nullable CompoundTag compoundTag) {
        if(compoundTag != null && compoundTag.contains("Texture")) {
            ...
            setTexture(BettasAquaticsMain.RANDOM.nextInt(Texture.values().length));
        }
