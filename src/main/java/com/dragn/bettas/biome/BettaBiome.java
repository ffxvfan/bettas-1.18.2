...
public class BettaBiome {
    ...
    public static final RegistryObject<Biome> BETTA_BIOME = BIOMES.register("betta_biome", BettaBiome::makeBettaBiome);

    private static Biome makeBettaBiome() {
        MobSpawnSettings.Builder mobSpawnSettings$builder = new MobSpawnSettings.Builder();
        BiomeDefaultFeatures.farmAnimals(mobSpawnSettings$builder);
        BiomeDefaultFeatures.commonSpawns(mobSpawnSettings$builder);
        mobSpawnSettings$builder.addSpawn(MobCategory.WATER_AMBIENT, new MobSpawnSettings.SpawnerData(BettasMain.BETTA_ENTITY.get(), 200, 1, 30));
        mobSpawnSettings$builder.addSpawn(MobCategory.WATER_AMBIENT, new MobSpawnSettings.SpawnerData(BettasMain.SNAIL_ENTITY.get(), 100, 1, 20));
