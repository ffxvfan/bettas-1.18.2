    ...
    public static void registerBiomes(BiomeLoadingEvent event) {
        switch (event.getCategory()) {
            case OCEAN -> {
                ...
                event.getSpawns().getSpawner(MobCategory.WATER_AMBIENT).add(new MobSpawnSettings.SpawnerData(BettasMain.SEADRAGON_ENTITY.get(), BettasCommonConfig.SEADRAGON_WEIGHT.get(), 1, 2));
                event.getSpawns().getSpawner(MobCategory.WATER_AMBIENT).add(new MobSpawnSettings.SpawnerData(BettasMain.PEACOCKSHRIMP_ENTITY.get(), BettasCommonConfig.PEACOCKSHRIMP_WEIGHT.get(), 1, 1));
            }
            case SWAMP -> {
                ...
                event.getSpawns().getSpawner(MobCategory.WATER_AMBIENT).add(new MobSpawnSettings.SpawnerData(BettasMain.CRYSTALSHRIMP_ENTITY.get(), BettasCommonConfig.CRYSTALSHRIMP_WEIGHT.get(), 1, 3));
                event.getSpawns().getSpawner(MobCategory.WATER_AMBIENT).add(new MobSpawnSettings.SpawnerData(BettasMain.PLECO_ENTITY.get(), BettasCommonConfig.PLECO_WEIGHT.get(), 1, 1));
                event.getSpawns().getSpawner(MobCategory.WATER_AMBIENT).add(new MobSpawnSettings.SpawnerData(BettasMain.SALAMANDER_ENTITY.get(), BettasCommonConfig.SALAMANDER_WEIGHT.get(), 1, 1));
            }
            case RIVER -> {
                event.getSpawns().getSpawner(MobCategory.WATER_AMBIENT).add(new MobSpawnSettings.SpawnerData(BettasMain.GHOSTSHRIMP_ENTITY.get(), BettasCommonConfig.GHOSTSHRIMP_WEIGHT.get(), 1, 3));
                event.getSpawns().getSpawner(MobCategory.WATER_AMBIENT).add(new MobSpawnSettings.SpawnerData(BettasMain.ISOPOD_ENTITY.get(), BettasCommonConfig.ISOPOD_WEIGHT.get(), 1, 1));
