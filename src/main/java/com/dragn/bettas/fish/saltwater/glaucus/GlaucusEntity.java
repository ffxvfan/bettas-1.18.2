...
public class GlaucusEntity extends AbstractSchoolingFish implements IAnimatable {
    ...
    public GlaucusEntity(EntityType<? extends GlaucusEntity> entity, Level level) {
        super(entity, level);
        this.noCulling = true;
    }

    public static boolean checkBettasAquaticsSpawnRules(EntityType<GlaucusEntity> entity, LevelAccessor level, MobSpawnType mobSpawnType, BlockPos pos, Random random) {
