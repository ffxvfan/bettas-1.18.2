...
public class SeaHorseEntity extends AbstractSchoolingFish implements IAnimatable {
    ...
    public SeaHorseEntity(EntityType<? extends SeaHorseEntity> entity, Level level) {
        super(entity, level);
        this.noCulling = true;
    }

    public static boolean checkBettasAquaticsSpawnRules(EntityType<SeaHorseEntity> entity, LevelAccessor level, MobSpawnType mobSpawnType, BlockPos pos, Random random) {
