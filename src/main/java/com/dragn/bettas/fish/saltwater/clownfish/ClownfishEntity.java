...
public class ClownfishEntity extends AbstractSchoolingFish implements IAnimatable {
    ...
    public ClownfishEntity(EntityType<? extends ClownfishEntity> entity, Level level) {
        super(entity, level);
        this.noCulling = true;
    }

    public static boolean checkBettasAquaticsSpawnRules(EntityType<ClownfishEntity> entity, LevelAccessor level, MobSpawnType mobSpawnType, BlockPos pos, Random random) {
