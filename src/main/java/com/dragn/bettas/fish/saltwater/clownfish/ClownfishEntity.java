...
public class ClownfishEntity extends AbstractSchoolingFish implements IAnimatable {
    ...
    public static boolean checkBettasTropicalFishSpawnRules(EntityType<ClownfishEntity> p_186232_, LevelAccessor levelAccessor, MobSpawnType p_186234_, BlockPos pos, Random p_186236_) {
