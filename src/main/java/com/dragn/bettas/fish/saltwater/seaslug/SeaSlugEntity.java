...
public class SeaSlugEntity extends AbstractFish implements IAnimatable {


    public static boolean checkBettasAquaticsSpawnRules(EntityType<SeaSlugEntity> entity, LevelAccessor level, MobSpawnType mobSpawnType, BlockPos pos, Random random) {
    ...
    public SeaSlugEntity(EntityType<? extends SeaSlugEntity> entityType, Level world) {
    ...
    public ItemStack getBucketItemStack() {
        return BettasMain.SEASLUG_BUCKET.get().getDefaultInstance();
    }
