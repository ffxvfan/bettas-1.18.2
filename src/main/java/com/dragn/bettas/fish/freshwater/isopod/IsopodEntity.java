...
public class IsopodEntity extends AbstractFish implements IAnimatable {
    ...
    public static boolean checkBettasAquaticsSpawnRules(EntityType<IsopodEntity> entity, ServerLevelAccessor level, MobSpawnType mobSpawnType, BlockPos pos, Random random) {
    ...
    public IsopodEntity(EntityType<? extends IsopodEntity> entityType, Level world) {
    ...
    public ItemStack getBucketItemStack() {
        return BettasMain.ISOPOD_BUCKET.get().getDefaultInstance();
    }
