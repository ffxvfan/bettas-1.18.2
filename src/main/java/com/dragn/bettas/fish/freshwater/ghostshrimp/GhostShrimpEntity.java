...
public class GhostShrimpEntity extends AbstractFish implements IAnimatable {
    ...
    public static boolean checkBettasAquaticsSpawnRules(EntityType<GhostShrimpEntity> entity, ServerLevelAccessor level, MobSpawnType mobSpawnType, BlockPos pos, Random random) {
    ...
    public GhostShrimpEntity(EntityType<? extends GhostShrimpEntity> entityType, Level world) {
    ...
    public ItemStack getBucketItemStack() {
        return BettasMain.GHOSTSHRIMP_BUCKET.get().getDefaultInstance();
    }
