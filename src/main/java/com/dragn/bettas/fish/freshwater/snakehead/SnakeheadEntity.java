...
public class SnakeheadEntity extends AbstractSchoolingFish implements IAnimatable {

    private final AnimationFactory factory = GeckoLibUtil.createFactory(this);


    public SnakeheadEntity(EntityType<? extends SnakeheadEntity> entity, Level level) {
        super(entity, level);
        this.noCulling = true;
    }

    public static boolean checkBettasAquaticsSpawnRules(EntityType<SnakeheadEntity> entity, ServerLevelAccessor level, MobSpawnType mobSpawnType, BlockPos pos, Random random) {
    ...
    public ItemStack getBucketItemStack() {
        return BettasMain.SNAKEHEAD_BUCKET.get().getDefaultInstance();
    }
