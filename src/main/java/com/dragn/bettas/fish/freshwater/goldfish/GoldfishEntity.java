...
public class GoldfishEntity extends AbstractSchoolingFish implements IAnimatable {

    private final AnimationFactory factory = GeckoLibUtil.createFactory(this);

    public static boolean checkBettasAquaticsSpawnRules(EntityType<GoldfishEntity> entity, ServerLevelAccessor level, MobSpawnType mobSpawnType, BlockPos pos, Random random) {
    ...
    public GoldfishEntity(EntityType<? extends GoldfishEntity> entity, Level level) {
        super(entity, level);
        this.noCulling = true;
    }
