...
public class MixinAbstractFish extends WaterAnimal implements Bucketable {

    private static final EntityDataAccessor<Boolean> FROM_BUCKET = SynchedEntityData.defineId(MixinAbstractFish.class, EntityDataSerializers.BOOLEAN);

    protected MixinAbstractFish(EntityType<? extends WaterAnimal> entityType, Level level) {
        super(entityType, level);
        this.moveControl = new MixinAbstractFish.FishMoveControl(this);
    }
        ...
        protected void registerGoals() {
            ...
            this.goalSelector.addGoal(4, new MixinAbstractFish.FishSwimGoal(this));
        }
    ...
    protected SoundEvent getFlopSound() {
        ...
        static class FishMoveControl extends MoveControl {
            private final MixinAbstractFish fish;

            FishMoveControl(MixinAbstractFish p_27501_) {
                super(p_27501_);
                this.fish = p_27501_;
            }
        ...
        static class FishSwimGoal extends RandomSwimmingGoal {
            ...
            public FishSwimGoal(MixinAbstractFish p_27505_) {
